...
//   - Real-time: tail a session JSONL file for live events
//   - Query: use cass search/context/export for historical data
...
// channel. This provides real-time observation while CASS indexes async.
// Blocks until ctx is cancelled or the file is closed.
