...
// Skaffen spawns this as a subprocess and connects as an MCP client,
// giving it structured access to agent session data without screen scraping.
package mcpsidecar
...
func New() (*Server, error) {
	...
	s := &Server{
		mcp: gomcp.NewServer(
			&gomcp.Implementation{Name: "skaffen-sidecar", Version: "0.1.0"},
			nil,
		),
		observer: obs,
	}
