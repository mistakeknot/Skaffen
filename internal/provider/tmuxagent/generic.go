...
// NewGenericAdapter creates an adapter for an arbitrary CLI agent.
func NewGenericAdapter(name, binary, cassConnector string, defaultArgs ...string) *GenericAdapter {
...
func (a *GenericAdapter) SpawnCmd(workDir string, cfg AgentConfig) (string, []string) {
...
func (a *GenericAdapter) ResumeCmd(_ string, _ string, _ AgentConfig) (string, []string) {
	return "", nil
}
