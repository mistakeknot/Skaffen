...
use skaffen::extensions_js::{applicable_rules, rule_by_id};
...
fn monorepo_escape_stub_loads_with_autostrict() {
    use skaffen::extensions::{ExtensionEventName, JsExtensionLoadSpec};
...
fn export_shape_named_activate_fallback() {
    use skaffen::extensions::ExtensionEventName;
