...
mod failure_taxonomy {
    ...
    use skaffen::provider_metadata::{PROVIDER_METADATA, provider_auth_env_keys};
    ...
    fn auth_diagnostic_codes_all_have_remediation() {
        use skaffen::error::AuthDiagnosticCode;
        let codes = [
    ...
    fn flake_classifier_covers_all_categories() {
        use skaffen::flake_classifier::{FlakeCategory, classify_failure};
    ...
    fn deterministic_failures_produce_non_retriable_classification() {
        use skaffen::flake_classifier::classify_failure;
