...
CONTRACT_ARTIFACT="${PROJECT_ROOT}/artifacts/controller_sandbox_membrane_v1.json"
OUTPUT_ROOT="${CSM_SMOKE_OUTPUT_DIR:-${PROJECT_ROOT}/target/controller-sandbox-smoke}"
...
usage() {
    cat <<'USAGE'
Usage: ./scripts/run_controller_sandbox_smoke.sh [options]
...
echo ""
echo "==================================================================="
echo "       CONTROLLER SANDBOX SMOKE SUMMARY                            "
echo "==================================================================="
