...
CONTRACT_ARTIFACT="${PROJECT_ROOT}/artifacts/digital_twin_v1.json"
OUTPUT_ROOT="${DIGITAL_TWIN_SMOKE_OUTPUT_DIR:-${PROJECT_ROOT}/target/digital-twin-smoke}"
...
usage() {
    cat <<'USAGE'
Usage: ./scripts/run_digital_twin_smoke.sh [options]
...
echo ""
echo "==================================================================="
echo "              DIGITAL TWIN SMOKE SUMMARY                           "
echo "==================================================================="
