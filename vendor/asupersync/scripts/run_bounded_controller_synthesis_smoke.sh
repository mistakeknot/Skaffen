...
CONTRACT_ARTIFACT="${PROJECT_ROOT}/artifacts/bounded_controller_synthesis_v1.json"
OUTPUT_ROOT="${BCS_SMOKE_OUTPUT_DIR:-${PROJECT_ROOT}/target/bounded-controller-synthesis-smoke}"
...
usage() {
    cat <<'USAGE'
Usage: ./scripts/run_bounded_controller_synthesis_smoke.sh [options]
...
echo ""
echo "==================================================================="
echo "       BOUNDED CONTROLLER SYNTHESIS SMOKE SUMMARY                  "
echo "==================================================================="
