...
# - capability-token-model-smoke-bundle-v1
# - capability-token-model-smoke-run-report-v1

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(dirname "$SCRIPT_DIR")"
CONTRACT_ARTIFACT="${PROJECT_ROOT}/artifacts/capability_token_model_v1.json"
OUTPUT_ROOT="${CTM_SMOKE_OUTPUT_DIR:-${PROJECT_ROOT}/target/capability-token-model-smoke}"
...
usage() {
    cat <<'USAGE'
Usage: ./scripts/run_capability_token_model_smoke.sh [options]
...
echo ""
echo "==================================================================="
echo "       CAPABILITY TOKEN MODEL SMOKE SUMMARY                        "
echo "==================================================================="
