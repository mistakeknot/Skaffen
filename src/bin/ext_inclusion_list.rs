...
use clap::Parser;
use skaffen::extension_inclusion::{
    ExclusionNote, InclusionEntry, InclusionList, InclusionStats, VersionPin, build_rationale,
    classify_registrations,
};
use skaffen::extension_license::ScreeningReport;
use skaffen::extension_popularity::{CandidateItem, CandidatePool, CandidateSource};
use skaffen::extension_scoring::ScoringReport;
use skaffen::extension_validation::{ValidationReport, ValidationStatus};
